...
import { FLOW_NODE_SUMMARY, PLAN_OPTION_CARDS, type PlanOptionCard } from '../data/planOptions'
...
type TreeCardNodeData = { card: PlanOptionCard; faded?: boolean }
const TreeCardNode = ({ data }: { data: TreeCardNodeData }) => {
...
const ExpertsNode = () => {
  const faces = ['/assets/ellipse-19.svg', '/assets/ellipse-20.svg', '/assets/ellipse-21.svg', '/assets/ellipse-18.svg']
  return (
...
type PanelNodeData = { onShowPlan?: () => void; onKeepWorking?: () => void; onPerfect?: () => void }

const KeyPiecesPanelNode = ({ data }: { data?: PanelNodeData }) => {
  const points = [
...
const BasicsPanelNode = ({ data }: { data?: PanelNodeData }) => {
  const points = [
